# FireFly Tokens Microservice for ERC721

This project provides a thin shim between [FireFly](https://github.com/hyperledger/firefly)
and an ERC721 contract exposed via [ethconnect](https://github.com/hyperledger/firefly-ethconnect).
...
- `POST /createpool` - Create a new instance of an ERC721 contract (inputs: name, symbol, data)
...
[ERC721 smart contract](solidity/contracts/ERC721WithData.sol).
