...
describe('AppController (e2e)', () => {
  ...
  it('Create new ERC721 contract instance', async () => {
  ...
  it('Create new ERC721 contract instance - valid type', async () => {
    const request: TokenPool = {
      data: 'tx1',
      name: 'testName',
      operator: IDENTITY,
  ...
  it('Create new ERC721 contract instance - invalid type', async () => {
    const request: TokenPool = {
      data: 'tx1',
      name: 'testName',
      operator: IDENTITY,
  ...
  it('Mint ERC721 token', async () => {
    ...
    expect(http.post).toHaveBeenCalledTimes(1);
    expect(http.post).toHaveBeenCalledWith(
      `${BASE_URL}${CONTRACT_URI}/${CONTRACT_ADDRESS}/_safeMint`,
      {
        tokenId: '2',
        _data: '0x74657374',
        to: '1',
  ...
  it('Transfer token', async () => {
    ...
    expect(http.post).toHaveBeenCalledTimes(1);
    expect(http.post).toHaveBeenCalledWith(
      `${BASE_URL}${CONTRACT_URI}/${CONTRACT_ADDRESS}/_safeTransferFrom`,
      {
        tokenId: '2',
        _data: '0x00',
        from: '1',
